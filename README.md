# ProStreet Menu Library

A shared library for Need for Speed: ProStreet in order to have multiple plugins' configurations in one global menu

![preview image](https://i.imgur.com/ktM6DWc.jpeg)
